...
public class DocumentsPath
{
    ...
    public static final String ETAT_PRODUIT_PERISABLE_FILE_PATH =ROOT_DIR+ "etat_produit_perisable.jrxml";
    public static final String ETAT_TAUX_MARQUE_PATH =ROOT_DIR+ "etat_periodique_taux_marque.jrxml";
    ...
    public static final String ETAT_PERIODIQUE_SORTIE_PRODUIT_FILE_PATH = ROOT_DIR+"etat_produit_Sortie_raison.jrxml";
