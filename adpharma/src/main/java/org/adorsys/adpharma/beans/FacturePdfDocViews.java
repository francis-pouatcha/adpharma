...
*/
	...
	vide2.setPhrase(new Phrase(new Chunk("", boddyStyle)));
		...
		document.add(new Paragraph(new Phrase(new Chunk("Arrete la facture a la somme de  :"+rbnf.format(facture.getNetPayer().intValue()).replace("-", " ").toUpperCase()+" FRANCS CFA", headerStyle))));
