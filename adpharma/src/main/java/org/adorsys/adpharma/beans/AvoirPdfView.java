...
public class AvoirPdfView extends   AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		AvoirClient bonAvoir= (AvoirClient) model.get("avoirClient");
		...
		tnCell.setPhrase(new Phrase(new Chunk("Agent : "+ bonAvoir.getAgent(), boddyStyle)));
		...
		caiCell1.setPhrase(new Phrase(new Chunk("NUMERO DU BON : "+bonAvoir.getNumero(),boddyStyle)));
		...
		if (bonAvoir.getMontant()!=null) {
			clienCell.setPhrase(new Phrase(new Chunk("MONTANT DU BON  : "+bonAvoir.getReste().intValue()+" FCFA", boddyStyle)));

		}else {
			clienCell.setPhrase(new Phrase(new Chunk("MONTANT DU BON  :  0 FCFA", boddyStyle)));
		...
		salCell2.setPhrase(new Phrase(new Chunk("TYPE DU BON :"+TypeBon.RETOUR.name(), boddyStyle)));
