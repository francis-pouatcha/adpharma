...
@Component("factureGlobaleDetaillee")
public class FactureGlobaleDetaillee extends AbstractPdfView  {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer, HttpServletRequest request,
		...
		for(DetteClient dette: listeDettes){
			Facture facture = Facture.findFacture(dette.getFactureId());
			
			try {
				document.add(new Paragraph(new  Phrase(new Chunk(" ========================================== DEBUT FACTURE No:"+facture.getFactureNumber()+" ===============================================", boddyStyle))));
			...
			try {
				document.add(new Paragraph(new  Phrase(new Chunk(" ============================================= FIN FACTURE ===========================================================", boddyStyle))));
			} catch (DocumentException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	protected void buildPdfMetadata(Map<String, Object> model,
		...
		HeaderFooter header = null ;
       	 ...
       	 header	= new HeaderFooter(new Phrase(new Chunk("FACTURE GLOBALE DETAILLEE " , headerStyle)), false);
