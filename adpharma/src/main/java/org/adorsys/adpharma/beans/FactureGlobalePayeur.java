...
@Component("factureGlobalePayeur")
public class FactureGlobalePayeur   extends   AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		napCell.setPhrase(new Phrase(new Chunk("Net", headerStyle)));
	...
	for (DetteClient line : listeDettes) {	
		...
		//Numero du bon 
			...
			inDesCell.setPhrase(new Phrase(new Chunk(line.getNumBon(), boddyStyle)));
